...
# Instantiates a movie with params movie_title, movie_storyline, poster_image, trailer_youtube
...
# Appends movie to a list
movies = [toy_story, avatar, warcraft, captain_america, the_notebook]
# Opens the movie page with given params in web browser
